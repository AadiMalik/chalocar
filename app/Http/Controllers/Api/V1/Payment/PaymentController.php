...
class PaymentController extends BaseController
{
    ...
    public function walletHistory()
    {
        ...
        if (get_settings(Settings::ENABLE_CCAVENUE) == 1) {
        ...
        return response()->json(['success' => true,
            ...
            'razorpay_test_secret_key' => get_settings(Settings::RAZOR_PAY_SECRET_KEY),
            'razorpay_live_secret_key' => get_settings(Settings::RAZOR_PAY_PRODUCTION_SECRET_KEY),
